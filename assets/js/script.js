!function(e) {
    function n(n) {
        for (var o, i, t = n[0], s = n[1], a = 0, d = []; a < t.length; a++) i = t[a], r[i] && d.push(r[i][0]), r[i] = 0;
    ...
    i.t = function(e, n) {
        ...
        if (i.r(o), Object.defineProperty(o, "default", {
            ...
            for (var r in e) i.d(o, r, function(n) {
                return e[n]
            }.bind(null, r));
        return o
    }, 
...
([function(e, n, o) {
    ...
    r = function() {
        ...
        function n(n) {
            ...
            var i, t = o(/(ipod|iphone|ipad)/i).toLowerCase(),
                s = !/like android/i.test(n) && /android/i.test(n),
                a = /nexus\s*[0-6]\s*/i.test(n),
                l = !a && /nexus\s*[0-9]+/i.test(n),
                d = /CrOS/.test(n),
                c = /silk/i.test(n),
                u = /sailfish/i.test(n),
                m = /tizen/i.test(n),
                p = /(web|hpw)os/i.test(n),
                f = /windows phone/i.test(n),
                v = (/SamsungBrowser/i.test(n), !f && /windows/i.test(n)),
                b = !t && !c && /macintosh/i.test(n),
                h = !s && !u && !m && !p && /linux/i.test(n),
                g = r(/edg([ea]|ios)\/(\d+(\.\d+)?)/i),
                w = o(/version\/(\d+(\.\d+)?)/i),
                E = /tablet/i.test(n) && !/tablet pc/i.test(n),
                S = !E && /[^-]mobi/i.test(n),
                y = /xbox/i.test(n);
            /opera/i.test(n) ? i = {
                name: "Opera",
                ...
                windowsphone: e
            }, g ? (i.msedge = e, i.version = g) : (i.msie = e, i.version = o(/iemobile\/(\d+(\.\d+)?)/i))) : /msie|trident/i.test(n) ? i = {
            ...
            }, /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(n) && (i.firefoxos = e, i.osname = "Firefox OS")) : c ? i = {
                name: "Amazon Silk",
                silk: e,
                ...
                name: o(/^(.*)\/(.*) /),
                version: r(/^(.*)\/(.*) /)
            }, !i.msedge && /(apple)?webkit/i.test(n) ? (/(apple)?webkit\/537\.36/i.test(n) ? (i.name = i.name || "Blink", i.blink = e) : (i.name = i.name || "Webkit", i.webkit = e), !i.version && w && (i.version = w)) : !i.opera && /gecko\//i.test(n) && (i.name = i.name || "Gecko", i.gecko = e, i.version = i.version || o(/gecko\/(\d+(\.\d+)?)/i)), i.windowsphone || !s && !i.silk ? !i.windowsphone && t ? (i[t] = e, i.ios = e, i.osname = "iOS") : b ? (i.mac = e, i.osname = "macOS") : y ? (i.xbox = e, i.osname = "Xbox") : v ? (i.windows = e, i.osname = "Windows") : h && (i.linux = e, i.osname = "Linux") : (i.android = e, i.osname = "Android");
            var O = "";
            ...
            }(o(/Windows ((NT|XP)( \d\d?.\d)?)/i)) : i.windowsphone ? O = o(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i) : i.mac ? O = (O = o(/Mac OS X (\d+([_\.\s]\d+)*)/i)).replace(/[_\s]/g, ".") : t ? O = (O = o(/os (\d+([_\s]\d+)*) like mac os x/i)).replace(/[_\s]/g, ".") : s ? O = o(/android[ \/-](\d+(\.\d+)*)/i) : i.webos ? O = o(/(?:web|hpw)os\/(\d+(\.\d+)*)/i) : i.blackberry ? O = o(/rim\stablet\sos\s(\d+(\.\d+)*)/i) : i.bada ? O = o(/bada\/(\d+(\.\d+)*)/i) : i.tizen && (O = o(/tizen[\/\s](\d+(\.\d+)*)/i)), O && (i.osversion = O);
            var T = !i.windows && O.split(".")[0];
            return E || l || "ipad" == t || s && (3 == T || T >= 4 && !S) || i.silk ? i.tablet = e : (S || "iphone" == t || "ipod" == t || s || a || i.blackberry || i.webos || i.bada) && (i.mobile = e), i.msedge || i.msie && i.version >= 10 || i.yandexbrowser && i.version >= 15 || i.vivaldi && i.version >= 1 || i.chrome && i.version >= 20 || i.samsungBrowser && i.version >= 4 || i.firefox && i.version >= 20 || i.safari && i.version >= 6 || i.opera && i.version >= 10 || i.ios && i.osversion && i.osversion.split(".")[0] >= 6 || i.blackberry && i.version >= 10.1 || i.chromium && i.version >= 20 ? i.a = e : i.msie && i.version < 10 || i.chrome && i.version < 20 || i.firefox && i.version < 20 || i.safari && i.version < 6 || i.opera && i.version < 10 || i.ios && i.osversion && i.osversion.split(".")[0] < 6 || i.chromium && i.version < 20 ? i.c = e : i.x = e, i
        }
        ...
        function s(e, r, i) {
            var s = o;
            "string" == typeof r && (i = r, r = void 0), void 0 === r && (r = !1), i && (s = n(i));
            var a = "" + s.version;
            for (var l in e)
        ...
        return o.test = function(e) {
            ...
            return !1
        }, o.isUnsupportedBrowser = s, o.compareVersions = t, o.check = function(e, n, o) {
            return !s(e, n, o)
            ...
            function() {
                ...
                for (var c in s)
                    if (s.hasOwnProperty(c)) {
                        if (e = [], (n = s[c]).name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length))
                            for (o = 0; o < n.options.aliases.length; o++) e.push(n.options.aliases[o].toLowerCase());
                        for (i = r(n.fn, "function") ? n.fn() : n.fn, a = 0; a < e.length; a++) 1 === (d = e[a].split(".")).length ? l[d[0]] = i : (!l[d[0]] || l[d[0]] instanceof Boolean || (l[d[0]] = new Boolean(l[d[0]])), l[d[0]][d[1]] = i), t.push((i ? "" : "no-") + d.join("-"))
                    }
            }(),
            function(e) {
                var n = d.className,
                ...
                l._config.enableClasses && (n += " " + o + e.join(" " + o), c ? d.className.baseVal = n : d.className = n)
            }(t), delete a.addTest, delete a.addAsyncTest;
...
function(e, n, o) {
    ...
    function s(e, n, r) {
        let i = document.getElementById("intro"),
            ...
            s = i.querySelector("p");
        t.innerHTML = e, s.innerHTML = n, i.style.visibility = "visible";
        let a = o(1);
        if (i.style.backgroundImage = "url(" + a + ")", r) {
    ...
    i.a.mobile || i.a.tablet ? (s("UNSUPPORTED DEVICE...", "MOBILE DEVICES ARE TEMPORARILY NOT SUPPORTED. PLEASE VISIT THIS SITE ON DESKTOP, AND USE ONE OF THE LATEST MODERN BROWSERS TO PLAY THIS GAME.", !0), t("event", "startup", {
        event_category: "game_page",
        event_label: "mobile",
        value: 0
    })) : i.a.msie ? (s("UNSUPPORTED BROWSER...", "YOUR CURRENT BROWSER IS NOT SUPPORTED. PLEASE USE ONE OF THE FOLLOWING SUPPORTED BROWSERS AND TRY AGAIN.", !0), t("event", "startup", {
        event_category: "game_page",
        event_label: "ie",
        value: 0
    })) : Modernizr.webgl ? Promise.all([o.e(0), o.e(1)]).then(o.bind(null, 10)).then(function(e) {
        document.getElementById("intro").remove(), t("event", "startup", {
            event_category: "game_page",
            event_label: "success",
            value: 1
        }), (new(0, e.default)).launch({
            first_name: "PLAYER 1",
            id: "user",
            picture: {
                data: {
        ...
        s("LAUNCH ERROR...", "AN ERROR OCCURRED WHEN LAUNCHING THE GAME, PLEASE TRY AGAIN LATER...", !1), t("event", "startup", {
            event_category: "game_page",
            event_label: "launch_error",
            value: 0
        })
    }) : (s("UNSUPPORTED BROWSER...", "IT LOOKS THAT THE CURRENT BROWSER DOES NOT SUPPORT WEBGL. PLEASE CHANGE TO ANOTHER WEBGL SUPPORTED BROWSER TO PLAY THIS GAME. ( SUCH AS BELOW, LATEST FIREFOX IS RECOMMENDED )", !0), t("event", "startup", {
        event_category: "game_page",
